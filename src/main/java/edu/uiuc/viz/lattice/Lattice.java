...
public class Lattice 
{
	...
	public Lattice generateFullyMaterializedLattice(Experiment exp, Distance distance, double iceberg_ratio,
...
//                    ArrayList<Double> measure_values = compute_visualization(new Node("#"),current_combination, current_permutation);
    ...
    public void generate_k_combinations(ArrayList<String> attribute_names, int len, int start, ArrayList<String> current_combination, 
    ...
    public void generate_value_permutations(ArrayList<ArrayList<String>> attribute_values, int depth,
    ...
    public ArrayList<Double> compute_visualization(Node node, ArrayList<String> current_combination, ArrayList<String> current_permutation
...
//	    		ArrayList<String> attrVals = uniqueAttributeKeyVals.get(attribute_names.get(attribute_positions.get(i)));
    ...
    public void combinationUtil(ArrayList<ArrayList<String>> all_combo,ArrayList<String> arr, ArrayList<String> data, int start,
	...
	*/
	public ArrayList<ArrayList<String>> combination(ArrayList<String> arr,   int r)
	{
